...
_Generated: 2026-05-13T06:05:30.580Z_
...
Workspace `mcp.json` _(folder: proyecto-final)_

- **c:\Users\03\Desktop\proyecto-final\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\03\AppData\Roaming\Code\User\mcp.json** — _File missing_
